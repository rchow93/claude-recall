    ...
    <div className="header">
      <h1>
        <div style={{ position: 'relative', display: 'inline-block' }}>
          <img src="claude-recall-logomark.webp" alt="" className={`logomark ${isProcessing ? 'spinning' : ''}`} />
          {queueDepth > 0 && (
      ...
      <div className="status">
        <a
          href="https://docs.claude-recall.ai"
          target="_blank"
        ...
        <GitHubStarsButton username="askqai" repo="claude-recall" />
        <select
          value={currentFilter}
