...
export class PendingMessageStore {
  ...
  /**
   * Clear old processed messages to prevent unbounded database growth
   * @param maxAgeMs Delete processed messages older than this (default: 24 hours)
   * @returns Number of messages deleted
   */
  clearOldProcessed(maxAgeMs: number = 24 * 60 * 60 * 1000): number {
